          ...
          <div className="content">
            <div className="content_rgt">
              <div className="rght_btn">
                ...
                <a href="javascript:void(0)" onClick={() => this.setState({ showForm: !this.state.showForm })}>
                  Upload Post
                </a>{" "}
              </div>
              {this.state.showForm ? (
                <UploadFrom
                  ...
                  closePopup={() => this.setState({ showForm: false })}
                />
              ) : null}
              <div className="rght_btn">
                {" "}
                ...
                <div className="sub_dwn">
                  <div className="feat_sec">
                    <div className="feat_sec_img">
                      <img src="images/feat_img1.png" alt="img" />
                    </div>
                  ...
                  <div className="feat_sec">
                    <div className="feat_sec_img">
                      <img src="images/feat_img2.png" alt="image_" />
                    </div>
                    <div className="feat_txt">Lorem Ipusum Text</div>
                    <div className="btm_rgt">
                  ...
                  <div className="feat_sec">
                    <div className="feat_sec_img">
                      <img src="images/feat_img3.png" alt="image_!" />
                    </div>
                    <div className="feat_txt">Lorem Ipusum Text</div>
                    <div className="btm_rgt">
        ...
        <div className="footr">
          ...
          <div className="footr_rgt">
            <ul>
              ...
              <li>
                <a href="/#">
                  <img src="images/social_2.png" alt="social_2" />
                </a>
              </li>
              <li>
                <a href="/#">
                  <img src="images/social_3.png" alt="social_3" />
                </a>
              </li>
              <li>
                <a href="/#">
